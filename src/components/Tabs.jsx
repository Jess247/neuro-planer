function Tabs() {
    ...
    const activeTabStyle = 'after:absolute after:content-[""] after:h-1 after:bg-[#F76C5E] after:w-10 after:top-9 after:left-[23vw] after:rounded-tr-md after:rounded-tl-md'
    return(
